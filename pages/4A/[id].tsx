...
const DashboardTableSection = () => {
    const body = [
        {etages: "Nom :",A:"4A",B:"4B",C:"4C",D:"4D",E:"4E"},
        {etages: "Prenom :",A:"3A",B:"3B",C:"3C",D:"3D",E:"3E" },
        {etages: "contrat:",A:"2A",B:"2B",C:"2C",D:"2D",E:"2E" },
        {etages: "dure de valididite:",A:"1A",B:"1B",C:"1C",D:"1D",E:"1E" },
        {etages: "date dexpiration:",A:"RA",B:"RB",C:"RC",D:"RD",E:"RE" },
        ...
        <table className="border-separate border border-slate-400 ">
                <thead className="border-b">
                  <tr className="bg-gray-400 border-b">
                    ...
                    <th colSpan={6} className="text-3xl font-medium text-white  font-light px-6 py-4 whitespace-nowrap text-center border-r">details</th>
                  </tr>
                </thead>
                ...
                <tbody>
                  {body.map((row, index) => (
                    ...
                    <td className="px-6 py-4  text-xl font-medium text-center text-white border-r">{row.etages}</td>
